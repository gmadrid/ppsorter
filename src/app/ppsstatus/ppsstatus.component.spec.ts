...
import {beforeEach, beforeEachProviders, describe, xdescribe, expect, it, xit, async, inject, injectAsync} from '@angular/core/testing';
...
describe('Component: PPSStatus', () => {
  ...
  beforeEachProviders(
      () => [TestComponentBuilder, PPSStatusComponent, MessageService]);
