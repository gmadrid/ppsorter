...
describe('Message Service', () => {
  ...
  it('should inject', inject([MessageService], (service: MessageService) => {
  ...
  it('should start empty',
     inject(
         [MessageService],
         (service: MessageService) => {service.message.onValue(
             (value: String) => {expect(value).toEqual('')})}));

  it('should accept new messages',
     inject([MessageService], (service: MessageService) => {
       var values = [];
       service.message.onValue((value: String) => { values.push(value); })
  ...
  it('can unsubscribe', inject([MessageService], (service: MessageService) => {
       var values = [];
       var unsub =
           service.message.onValue((value: String) => { values.push(value); })
       service.AddMessage('George');
